<template>
	<view class="wrapper">
      ...
      <view class="meta"> -->
		...
		<!-- 统计 -->
		<view class="count">
			<view class="cell"> 8 <text style="color: #AAAAAA;">我的粉丝</text> </view>
			<view class="cell"> 14 <text style="color: #AAAAAA;">关注景点</text> </view>
			<view class="cell"> 18 <text style="color: #AAAAAA;">智慧出行</text> </view>
			<view class="cell"> 238.64 <text style="color: #AAAAAA;">行走里程</text> </view>
		</view>
		<!-- 我的订单 -->
		<view class="orders">
			...
			<view class="sorts" >
					<view style="margin-top: -10rpx;margin-left: 60rpx;" @tap="gotoFeeds('/pages/sort/sort')">
						<image src='@/static/img/allCard.png' class="swiper-image"></image>
					</view>
					<view style="margin-top: 60rpx;margin-left: -60rpx;margin-bottom: -20rpx;" @tap="gotoFeeds('/pages/img/allCard')">
						<text class="icon-bill">全部订单</text>
					</view>
	
					<view style="margin-top: -15rpx;margin-left: 95rpx;" @tap="gotoFeeds('/pages/img/sort')">
						<image src='@/static/img/readPay.png' class="swiper-image"></image>
					</view>
					<view style="margin-top: 60rpx;margin-left: -75rpx;margin-bottom: -20rpx;" @tap="gotoFeeds('/pages/sort/sort')">
						<text class="icon-car">待支付</text>
					</view>

					<view style="margin-top: -15rpx;margin-left: 95rpx;" @tap="gotoFeeds('/pages/sort/sort')">
						<image src='@/static/img/goout.png' class="swiper-image"></image>
					</view>
					<view style="margin-top: 60rpx;margin-left: -80rpx;margin-bottom: -20rpx;" @tap="gotoFeeds('/pages/sort/sort')">
						<text class="icon-money">待出行</text>
					</view>

					<view style="margin-top: -15rpx;margin-left: 95rpx;" @tap="gotoFeeds('/pages/sort/sort')">
						<image src='@/static/img/history.png' class="swiper-image"></image>
					</view>
					<view style="margin-top: 60rpx;margin-left: -85rpx;margin-bottom: -20rpx;" @tap="gotoFeeds('/pages/sort/sort')">
						<text class="icon-list">历史出行</text>
					</view>
		...
		<!-- 其它 -->
		<view class="extra">
			<view @click="makePhone" class="item icon-arrow">联系客服啊</view>
